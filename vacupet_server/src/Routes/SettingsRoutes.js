...
exports.GetSettingsRoutes = void 0;
...
function GetSettingsRoutes(dataSource) {
    var _this = this;
    var loggerCfg = __assign(__assign({}, JSON.parse((0, Utils_1.decryptENV)(process.env.LOGGER))), { operationId: '/setting' });
    ...
    var settingController = new SettingsController_1.SettingsController(logger, dataSource);
    router.post('/', [loggerOptions, function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var gResponse, setting, settingResponse, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, settingController.createUpdateSetting(setting)];
                    case 2:
    ...
    router.get('/', [loggerOptions, function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var gResponse, settings, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, 3, 4]);
                        return [4 /*yield*/, settingController.getAllSettings()];
                    case 1:
                        settings = _a.sent();
                        gResponse = {
                            Success: true,
    ...
    router.put('/', [loggerOptions, function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var gResponse, setting, settingResponse, e_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        setting = req.body;
